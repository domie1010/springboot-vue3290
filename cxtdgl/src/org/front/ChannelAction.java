...
public class ChannelAction extends ActionSupport {
	...
	private Channel entity = new Channel();

	private Map<String, Object> dataMap = new HashMap<String, Object>();

	@Autowired
	private ChannelDao entityDao;
	...
	public String list() {
		...
		try {
			...
			if (listCount > 0) {
				...
				List<Channel> entityList = (List<Channel>)entityDao.findList(entity, pageUtil.getStart(), pageUtil.getPageSize());
	...
	public String listAll() {
		...
		dataMap.clear();
		try {
			List<Channel> entityList = (List<Channel>)entityDao.findAllList(entity);
			dataMap.put("list", entityList);
			context.put("list", entityList);
			dataMap.put("message", "查询成功！");
			context.put("message", "查询成功！");
