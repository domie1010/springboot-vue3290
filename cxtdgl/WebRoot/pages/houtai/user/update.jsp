...
<body>
    ...
    <form id="saveUpdateForm" action="<%=basePath%>user-update.action" method="post">
    <input type="hidden" name="entity.id" value="${entity.id}" />
    <input type="hidden" name="entity.type" value="${entity.type}" />
    <input type="hidden" name="entity.isenable" value="${entity.isenable}" />
    <ul class="forminfo">
    ...
    <li><label>&nbsp;</label><cite><input name="" type="submit" class="btn" value="确认保存"/>&nbsp;&nbsp;&nbsp;&nbsp;<font color="red">${message}</font> </cite></li>
    </ul>
    </form>
    </div>
</body>
